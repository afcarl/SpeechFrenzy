...
def downloadVideo(channelID, videoID):
  ...
  os.system("lib\youtube-dl.exe -f bestaudio -o "+INPUT_DIR+videoIDName+" https://www.youtube.com/watch?v="+videoID)

def deleteVideo():
  os.system('del '+INPUT_DIR+videoIDName)

def mkdir():
  mkcmd = 'mkdir '+OUTPUT_DIR+folderName
  os.system(mkcmd)
  os.system('copy nul >'+ OUTPUT_DIR+folderName+captionFileName)
